...
cmd.CommandText = "Update 客戶資料表 Set Interest=? Where Serial = ?"

	cmd.Parameters.Add("@Interest",OleDBType.Varchar).Value =  IIf((Request("Interest") <> Nothing), Request("Interest"),"") 
