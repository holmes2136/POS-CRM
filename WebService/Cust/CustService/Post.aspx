...
cmd.CommandText = "Update 客戶通訊資料庫 Set UnderTaker=?,ServiceContent=? Where Serial = ?"
	
'	cmd.Parameters.Add("@CustId",OleDBType.Varchar).Value =  IIf((Request.QueryString("CustId") <> Nothing), Request.QueryString("CustId"),"") 
	cmd.Parameters.Add("@UnderTaker",OleDBType.Varchar).Value =  IIf((Request("UnderTaker") <> Nothing), Request("UnderTaker"),"") 
	cmd.Parameters.Add("@ServiceContent",OleDBType.Varchar).Value =  IIf((Request("SC") <> Nothing), Request("SC"),"") 
