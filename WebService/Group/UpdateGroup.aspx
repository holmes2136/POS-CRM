...
cmd.CommandText = "Update 客戶資料表 Set CustGroup=? Where Serial = ?"

	cmd.Parameters.Add("@CustGroup",OleDBType.Varchar).Value =  IIf((Request("CustGroup") <> Nothing), Request("CustGroup"),"") 
