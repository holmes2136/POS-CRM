...
<form runat="server">
		...
		sql = "SELECT TOP 200 * FROM 客戶資料表"
	
		
		
        Dim conn As OleDbConnection = Connection.getConnection
        Dim cmd As New OleDbCommand
		'Dim sql As String = "select * from 客戶資料表 Where CustId In( " & CustIdGroup & ")"
        cmd.CommandText = sql
        cmd.Connection = conn
        conn.Open()
    ...
    Response.write("<table border=1 width=968>")
	   	 		
 	For i As Integer = 1 To ret.Count -1
		Response.write("<tr>")
		Response.write("<td>&nbsp;&nbsp;" & Ctype(ret.Item(i),AddreLabel).getCustAddress)
		Response.write("<p>")
		Response.write("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" &  Ctype(ret.Item(i),AddreLabel).getCustName & "啟</td>")
		
		Response.write("<td> &nbsp;&nbsp;" &  Ctype(ret.Item(i+1),AddreLabel).getCustAddress)
		Response.write("<p>")
		Response.write("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" & Ctype(ret.Item(i+1),AddreLabel).getCustName & "啟</td>")
